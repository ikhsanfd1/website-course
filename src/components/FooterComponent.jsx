    ...
    <div className="footer py-5">
      <Container>
        <Row className="d-flex justify-content-between">
          <Col lg="5">
            <h3 className="fw-bold">WowBootcamp.</h3>
            <p className="desc">
              Lorem ipsum dolor, sit amet consectetur adipisicing elit. Vel nam
              suscipit reiciendis maxime,consequuntur neque incidunt corrupti,
              dolore natus!
            </p>
        ...
        <Row>
          <Col>
            <p className="text-center px-md-0 px-3">
              ...
              <span className="fw-bold">Ikhsan FD</span>, All Right Reserved
            </p>
          </Col>
        </Row>
      </Container>
